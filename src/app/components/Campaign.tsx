...
const Campaign = () => {
  return (
    <div className="w-screen sm:h-[80vh] h-[60vh] flex sm:flex-row flex-col sm:justify-between sm:items-center sm:mb-14 sm:pt-0 pt-10" id="Campaigns">
      <div className="flex items-center sm:h-full md:gap-10 sm:gap-5">
        <div className="lg:h-[50vh] sm:h-[31vh] h-20 flex justify-center items-center">
          <img
        ...
        >
          <h1 className=" bg-gradient-to-br from-[#283BF8] to-[#B8BEFF] text-transparent bg-clip-text font-semibold lg:text-8xl md:text-6xl sm:text-xl text-base leading-[1.2] tracking-[0.1em] w-52 lg:w-72 lg:ml-16">
            CAMPAIGNS
          </h1>
        </div>
      </div>
      <div className="sm:h-full md:w-[70%] w-[26rem] flex">
        ...
        <div className="h-full w-[75%] md:pl-10 pl-36 sm:pr-10 flex relative lg:mt-10 md:mt-24 sm:mt-32 mt-6">
