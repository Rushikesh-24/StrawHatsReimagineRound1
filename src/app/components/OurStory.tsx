  ...
  return (
    <section className="text-white text-lg md:text-xl pb-20 pt-10 w-full" id="About">
      ...
      <p className="text-center mt-10 sm:mt-0">
        Amul was founded on December 19, 1946 in Anand, Gujarat, India.
      </p>
      <div className="mt-20">
        <div>
          <div className="lg:bg-[#212FBF] relative rounded-full flex flex-wrap sm:flex-nowrap items-start md:whitespace-nowrap justify-center md:justify-start md:h-[30rem] md:w-[30rem] sm:-ml-10">
            ...
            <div>
              ...
              <p className="text-3xl md:text-5xl lg:text-6xl font-semibold my-4">
                Founder of Amul
              </p>
              <p
                className={`uppercase text-xl md:text-3xl lg:text-4xl tracking-wide ${koulen.className}`}
              >
                The man who transformed the dairy <br /> landscape
              </p>
            </div>
          </div>
          <div className="relative">
            <div className="bg-[#000D89] ml-[75%] relative rounded-full hidden items-end justify-evenly overflow-hidden md:whitespace-nowrap h-[30rem] w-[35rem] lg:flex lg:-mt-[25%]">
            <Image
                src={"/Verghese.png"}
            ...
            <div className="relative lg:absolute flex flex-wrap sm:flex-nowrap gap-5 text-left sm:text-right justify-center lg:justify-end bottom-0 right-0 mt-20 md:mt-0">
              <div className="order-2 sm:order-1 sm:ml-0 ml-4">
                ...
                <p
                  className={`uppercase text-xl md:text-3xl lg:text-4xl tracking-wide ${koulen.className}`}
                >
                  The man who orchestrated Amul’s
                  <br /> meteoric rise
                </p>
              </div>
              <Image
                ...
                width={Verghese.width - 200}
                alt="Verghese Kurien"
                className="-mt-10 order-1 lg:opacity-0 flex"
              />
            </div>
            <GradientVer />
          </div>
      ...
      <div className="ml-10 mt-5 sm:mt-0">
        <button className="flex gap-5 items-center">
          ...
          <span className="text-6xl sm:text-8xl font-semibold text-[#23B6FF]">
            {">"}
          </span>
        </button>
      </div>
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="60"
            result="effect1_foregroundBlur_323_144"
          />
        </filter>
      </defs>
    </svg>
...
function GradientVer() {
  return (
    <svg
      className="absolute hidden sm:block right-0 z-[-1] -top-[50%]"
      width="1211"
      height="1591"
