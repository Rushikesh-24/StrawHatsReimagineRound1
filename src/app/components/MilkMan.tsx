...
const MilkMan = () => {
  return (
    <div className="md:h-screen h-[60vh] w-screen flex justify-start items-center md:items-start overflow-hidden relative py-20">
...
function Gradient() {
  return (
    ...
    className="absolute size-fit -z-10"
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g filter="url(#filter0_f_323_175)">
        <ellipse cx="380" cy="270" rx="197" ry="87" fill="#283BF8" />
      </g>
      <defs>
        <filter
          id="filter0_f_323_175"
          x="0.165222"
          y="0.165222"
          width="759.67"
          height="539.67"
        ...
        >
          ...
          />
          <feGaussianBlur
            stdDeviation="91.4174"
            result="effect1_foregroundBlur_323_175"
          />
        </filter>
      </defs>
    </svg>
